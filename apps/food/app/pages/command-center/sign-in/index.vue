        ...
        <div>
          ...
          <div v-if="state.login && state.password" class="flex flex-row gap-4 justify-center">
            <button
              ...
              class="px-5 py-3 flex flex-row gap-2 justify-center items-center text-base font-medium cursor-pointer bg-gray-200 hover:bg-gray-300 hover:scale-95 duration-200 rounded-2xl disabled:animate-pulse"
              @click="sighIn"
            >
